...
extern unsigned     u8_charnum(const char *s, int offset);
...
extern char*        u8_strchr(const char *s, uint32_t ch, unsigned *charn);
extern char*        u8_memchr(const char *s, uint32_t ch, size_t sz, unsigned *charn); /* doesn't stop at end of string char, but at sz*/
